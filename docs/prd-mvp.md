...
### F4 — Figure + ฟิสิกส์ของรางวัล
- figure 1 แบบ (กล่อง/ทรงง่ายก่อน) มี Rigidbody + Convex Mesh Collider
- น้ำหนัก ~0.3 kg, PhysicsMaterial friction ต่ำ (0.15/0.20 metal-on-plastic)
- วางได้หลายตัวในตู้ (กองรวมกัน)

### F5 — ท่อรับของ (Chute)
- Trigger zone ที่มุมตู้ — ของตกใส่ → นับว่า "คีบได้" → log/counter +1
- (MVP: แค่ detect + log; ยังไม่ต้องเข้า inventory)
